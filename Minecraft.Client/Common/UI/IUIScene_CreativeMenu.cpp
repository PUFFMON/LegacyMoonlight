...
void IUIScene_CreativeMenu::staticCtor()
{
	...
	DEF(eCreativeInventory_BuildingBlocks)
		ITEM(Tile::stone_Id)
		ITEM_AUX(Tile::stone_Id, StoneTile::TYPE_GRANITE)
		ITEM_AUX(Tile::stone_Id, StoneTile::TYPE_POLISHED_GRANITE)
		ITEM_AUX(Tile::stone_Id, StoneTile::TYPE_DIORITE)
		ITEM_AUX(Tile::stone_Id, StoneTile::TYPE_POLISHED_DIORITE)
		ITEM_AUX(Tile::stone_Id, StoneTile::TYPE_ANDESITE)
		ITEM_AUX(Tile::stone_Id, StoneTile::TYPE_POLISHED_ANDESITE)
		ITEM(Tile::grass_Id)
		ITEM(Tile::dirt_Id)
